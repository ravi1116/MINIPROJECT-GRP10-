...
"""
#istall pip before installing any packages
# pip install pip
import cv2  # pip install opencv-python
import numpy as np# pip install numpy
import argparse #dont need any lib for this if its python3
import time# pip install DateTime
import hashlib #dont need any lib for this if its python3
import hmac #dont need any lib for this if its python3
import sys #dont need any lib for this if its python3
